...
"""
QUESTION 1a: In this file, we obtain the count of the lines and the unique lines as well. 
"""
...
def FilterData01():
    ...
    printer(uniq)
    print("Total number of lines is: ", len(rdd_split))
    print("Total number of unique line is: ", len(uniq.collect() ) )
